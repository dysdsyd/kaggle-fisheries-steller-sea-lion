...
https://github.com/gecrooks/sealionengine/blob/master/sealiondata.py
"""
...
SOURCEDIR = os.path.join('F:/DS-main/Kaggle-main/NOAA Fisheries Steller Sea Lion Population Count - inputs')
...
class SeaLionData(object):
    ...
    def __init__(self, sourcedir=SOURCEDIR, outdir=OUTDIR, verbosity=VERBOSITY.NORMAL):
        ...
        self.paths = {
            ...
            # Data paths
            'coords'     : os.path.join(outdir, 'coords_v4.csv'),
